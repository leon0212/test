...
function draw(){
  ...
  //labels for sliders
  stroke(0);
  text("Mass of Cats",150,490);
  text("Mass of Raft",150,540);

  //text value of slider
  text(raftslider.value().toString(),100,578);
  text(catslider.value().toString(),100,527);
